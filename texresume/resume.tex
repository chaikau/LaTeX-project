...
\title{{\song Your Name} -- Résumé} % Print the main header
...
{\bf Address} \> {\song 电子科技大学} (UESTC), \\ % Address line 1
\> Chengdu, Sichuan \\ % Address line 2
{\bf Date of Birth} \> Date of birth \\ % Date of birth 
...
{\bf Mobile Phone} \> +86 12345678900\\ % Mobile phone
...
Description \> The base of Microelectronic Devices and the principle of Integrated Circuit\\
\textit{GPA} \> 3.6 \\
